  ...
  quizzes: Quiz[] = [
    {
      ...
      answer: [
        ...
        {
          option: '18 elementos de transición en el tercer período',
          correct: false,
        },
    ...
    {
      question:
        'Los números cuánticos del último electrón de un elemento son: 4, 1, -1, -1/2 entonces:',
      answer: [
        { option: 'su número atómico es 18', correct: false },
        {
          option:
            'su ión divalente negativo presenta una configuración electrónica iguala a la del Kr',
          correct: true,
        },
    ...
    {
      question:
        'Entre los elementos que tienen múltiples estados de oxidación están:',
      answer: [
